...
public class CinemaTest {
    ...
    public void should_return_30_for_single_ticket() {
        Double result = 30D;
        Double expected = new Cinema().getPriceFor2DMovieAndCashPayment(1);
    ...
    public void should_return_60_for_two_tickets() {
        Double result = 60D;
        Double expected = new Cinema().getPriceFor2DMovieAndCashPayment(2);
        assertThat(result, is(expected));
    }

    @Test
    public void should_return_60_for_single_ticket_of_3d_movie() {
        Double result = new Cinema().getPriceForCashPayment(1, "3D");
        Double expected = 60D;
        assertThat(result, is(expected));
    }
    ...
    public void should_return_120_for_two_tickets_of_3d_movie() {
        Double result = new Cinema().getPriceForCashPayment(2, "3D");
    ...
    public void should_return_30_for_single_ticket_of_2d_movie() {
        Double result = new Cinema().getPriceForCashPayment(1, "2D");
        Double expected = 30D;
        assertThat(result, is(expected));
    }
    ...
    public void should_return_60_for_two_tickets_of_2d_movie() {
        Double result = new Cinema().getPriceForCashPayment(2, "2D");
        Double expected = 60D;
        assertThat(result, is(expected));
    }
    ...
    public void should_return_48_for_single_ticket_of_3d_movie_using_card() {
        Double result = new Cinema().getPrice(1, "3D", "card");
        Double expected = 48D;
        assertThat(result, is(expected));
    }
    ...
    public void should_return_96_for_two_tickets_of_3d_movie_using_card() {
        Double result = new Cinema().getPrice(2, "3D", "card");
        Double expected = 96D;
        assertThat(result, is(expected));
    }
    ...
    public void should_return_60_for_single_ticket_of_3d_movie_using_cash() {
        Double result = new Cinema().getPrice(1, "3D", "cash");
        Double expected = 60D;
        assertThat(result, is(expected));
    }
    ...
    public void should_return_120_for_two_tickets_of_3d_movie_using_cash() {
        Double result = new Cinema().getPrice(2, "3D", "cash");
        Double expected = 120D;
        assertThat(result, is(expected));
    }
    ...
    public void should_return_24_for_single_ticket_of_2d_movie_using_card() {
        Double result = new Cinema().getPrice(1, "2D", "card");
        Double expected = 24D;
        assertThat(result, is(expected));
    }
    ...
    public void should_return_48_for_two_tickets_of_2d_movie_using_card() {
        Double result = new Cinema().getPrice(2, "2D", "card");
        Double expected = 48D;
        assertThat(result, is(expected));
    }
    ...
    public void should_return_30_for_single_ticket_of_2d_movie_using_cash() {
        Double result = new Cinema().getPrice(1, "2D", "cash");
        Double expected = 30D;
        assertThat(result, is(expected));
    }
    ...
    public void should_return_60_for_two_tickets_of_2d_movie_using_cash() {
        Double result = new Cinema().getPrice(2, "2D", "cash");
        Double expected = 60D;
        assertThat(result, is(expected));
    }
}
